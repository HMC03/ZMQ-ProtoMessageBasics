...
const uint32_t TableStruct_message_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::mypackage::MyMessage, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::mypackage::MyMessage, _impl_.id_),
  PROTOBUF_FIELD_OFFSET(::mypackage::MyMessage, _impl_.text_),
  PROTOBUF_FIELD_OFFSET(::mypackage::MyMessage, _impl_.status_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::mypackage::MyMessage)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::mypackage::_MyMessage_default_instance_._instance,
};

const char descriptor_table_protodef_message_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\rmessage.proto\022\tmypackage\032\nenum.proto\"H"
  "\n\tMyMessage\022\n\n\002id\030\001 \001(\005\022\014\n\004text\030\002 \001(\t\022!\n"
  "\006status\030\003 \001(\0162\021.mypackage.Statusb\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_message_2eproto = {
    false, false, 120, descriptor_table_protodef_message_2eproto,
    "message.proto",
...
MyMessage::MyMessage(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:mypackage.MyMessage)
}
MyMessage::MyMessage(const MyMessage& from)
  ...
  // @@protoc_insertion_point(copy_constructor:mypackage.MyMessage)
}
...
MyMessage::~MyMessage() {
  // @@protoc_insertion_point(destructor:mypackage.MyMessage)
...
// @@protoc_insertion_point(message_clear_start:mypackage.MyMessage)
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "mypackage.MyMessage.text"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          ...
          CHK_(ptr);
          _internal_set_status(static_cast<::mypackage::Status>(val));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* MyMessage::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:mypackage.MyMessage)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:mypackage.MyMessage)
  return target;
}

size_t MyMessage::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:mypackage.MyMessage)
  size_t total_size = 0;
...
void MyMessage::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:mypackage.MyMessage)
...
// @@protoc_insertion_point(class_specific_copy_from_start:mypackage.MyMessage)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void MyMessage::InternalSwap(MyMessage* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(MyMessage, _impl_.status_)
      + sizeof(MyMessage::_impl_.status_)
...
template<> PROTOBUF_NOINLINE ::mypackage::MyMessage*
Arena::CreateMaybeMessage< ::mypackage::MyMessage >(Arena* arena) {
  return Arena::CreateMessageInternal< ::mypackage::MyMessage >(arena);
}
