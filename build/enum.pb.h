...
constexpr Status Status_MAX = TIMEOUT;
...
template <> struct is_proto_enum< ::mypackage::Status> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::mypackage::Status>() {
  return ::mypackage::Status_descriptor();
}
